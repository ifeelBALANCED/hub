...
export type MeetingParticipantResponseLeftAt = number | null
...
export interface MeetingParticipantResponse {
  ...
  meeting_id: string
  joined_at: number
  left_at?: MeetingParticipantResponseLeftAt
}

export type MeetingResponseEndedAt = number | null
...
export interface MeetingResponse {
  ...
  is_active: boolean
  created_at: number
  ended_at?: MeetingResponseEndedAt
...
/**
 * Create a new meeting with auto-generated room_id
 * @summary Create Meeting
 */
export const createMeetingMeetingsPost = (
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<MeetingResponse>({ url: `/meetings/`, method: 'POST', signal }, options)
}

export const getCreateMeetingMeetingsPostMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof createMeetingMeetingsPost>>,
    TError,
    void,
    TContext
  >
  ...
  TContext
> => {
  const mutationKey = ['createMeetingMeetingsPost']
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return createMeetingMeetingsPost(requestOptions)
  }

  return { mutationFn, ...mutationOptions }
}

export type CreateMeetingMeetingsPostMutationResult = NonNullable<
  Awaited<ReturnType<typeof createMeetingMeetingsPost>>
>

export type CreateMeetingMeetingsPostMutationError = ErrorType<unknown>

/**
 * @summary Create Meeting
 */
export const useCreateMeetingMeetingsPost = <TError = ErrorType<unknown>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof createMeetingMeetingsPost>>,
      TError,
  ...
  TContext
> => {
  const mutationOptions = getCreateMeetingMeetingsPostMutationOptions(options)
